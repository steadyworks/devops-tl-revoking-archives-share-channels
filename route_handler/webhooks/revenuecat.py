...
from db.dal import DALEntitlements
from db.dal.base import FilterOp, safe_transaction
from db.dal.schemas import DAOEntitlementsCreate, DAOEntitlementsUpdate
...
if TYPE_CHECKING:
    from db.data_models import DAOEntitlements
