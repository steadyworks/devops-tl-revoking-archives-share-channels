...
from lib.payments.stripe.base import StripeCreatePaymentIntentResult
from route_handler.checkout import (
    CheckoutAPIHandler,
...
async def test_CI4_db_failure_triggers_stripe_cancel_and_500(
    ...
    from db.dal import DALPayments as _DALPaymentsReal
