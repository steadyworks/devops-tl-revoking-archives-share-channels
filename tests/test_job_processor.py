...
from db.dal import safe_transaction
...
from lib.notifs.email.types import EmailMessage, EmailSendResult
from lib.sharing.service import initialize_shares_and_channels_in_txn
from lib.utils.common import utcnow
from worker.job_processor.remote_deliver_notification import (
...
if TYPE_CHECKING:
    ...
    from worker.process.types import RemoteIOBoundWorkerProcessResources
