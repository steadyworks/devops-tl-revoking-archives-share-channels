...
from db.dal import DALAssets, DAOAssetsUpdate, safe_commit
from db.data_models import AssetUploadStatus
...
from lib.geo.radar_models import RadarReverseGeocodeResponse
...
from lib.utils.web_requests import async_tempdir
from worker.process.types import RemoteCPUBoundWorkerProcessResources
        ...
        async with async_tempdir() as root_dir:
            try:
                ...
                for compressed_path in succeeded_uploaded_compressed_paths:
                    ...
                    if exif is not None:
                        writes[uuid].exif = exif.serialize()
