...
from lib.layout.layout_management import (
    SectionRenderContext,
    get_all_layout_options,
)
from lib.utils.common import none_throws
from lib.utils.retryable import retryable_with_backoff
from lib.vertex_ai.gemini import (
    Gemini,
    RawLLMPrompt,
...
class RemotePhotobookGenerationJobProcessor(
    ...
    async def auto_match_layout(
        ...
        assert len(layouts) == len(photobook.photobook_pages), (
